...
import os
img = cv2.imread(os.getcwd()+'/imgs/blue_mini_zjz.png')
...
rect = (30, 30, img.shape[1], img.shape[0])
...
plt.subplot(122), plt.imshow(cv2.cvtColor(cv2.imread(os.getcwd()+'/imgs/blue_mini_zjz.png'), cv2.COLOR_BGR2RGB))
